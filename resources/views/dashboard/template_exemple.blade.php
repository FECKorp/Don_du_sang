                ...
                <div class="card white-box p-0">
                    ...
                    <div class="comment-widgets">
                        ...
                        <div class="d-flex flex-row comment-row p-3 mt-0">
                            <div class="p-2">
                                <img
                                    src="{{ asset("dashboard/plugins/images/users/varun.jpg") }}"
                                    alt="user"
                                    width="50"
                        ...
                        <div class="d-flex flex-row comment-row p-3">
                            <div class="p-2">
                                <img
                                    src="{{ asset("dashboard/plugins/images/users/ritesh.jpg") }}"
                                    alt="user"
                                    width="50"
                                    class="rounded-circle"
                                />
                          ...
                          >
                            ...
                            <li>
                                ...
                                <a
                                    ...
                                    class="d-flex align-items-center"
                                ><img
                                        src="{{ asset("dashboard/plugins/images/users/genu.jpg") }}"
                                        alt="user-img"
                                        class="img-circle"
                                    />
                                    <div class="ms-2">
                          ...
                          >
                            ...
                            <li>
                                ...
                                <a
                                    ...
                                    class="d-flex align-items-center"
                                ><img
                                        src="{{ asset("dashboard/plugins/images/users/arijit.jpg") }}"
                                        alt="user-img"
                                        class="img-circle"
                                    />
                                    <div class="ms-2">
                          ...
                          >
                            ...
                            <li>
                                ...
                                <a
                                    ...
                                    class="d-flex align-items-center"
                                ><img
                                        src="{{ asset("dashboard/plugins/images/users/govinda.jpg") }}"
                                        alt="user-img"
                                        class="img-circle"
                                    />
                                    <div class="ms-2">
                          ...
                          >
                            ...
                            <li>
                                ...
                                <a
                                    ...
                                    class="d-flex align-items-center"
                                ><img
                                        src="{{ asset("dashboard/plugins/images/users/hritik.jpg") }}"
                                        alt="user-img"
                                        class="img-circle"
                                    />
                                    <div class="ms-2">
